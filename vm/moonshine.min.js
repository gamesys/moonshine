...
a=a.__shine.numValues;var b=shine.gc.createArray(),c,d=0;for(c in a)a.hasOwnProperty(c)&&(b[c]=!0);for(;b[d+1];)d++;if(0<d&&void 0===a[d]){for(c=0;1<d-c;)b=Math.floor((c+d)/2),void 0===a[b]?d=b:c=b;return c}return d},insert:function(a,b,c){if(!((a||shine.EMPTY_OBJ)instanceof shine.Table))throw new shine.Error("Bad argument #1 to 'insert' (table expected)");void 0==c?(c=b,b=a.__shine.numValues.length):b=shine.utils.coerce(b,"number","Bad argument #2 to 'insert' (number expected)");var d=a.getMember(b);
a.setMember(b,c);d&&shine.lib.table.insert(a,b+1,d)},maxn:function(a){if(!((a||shine.EMPTY_OBJ)instanceof shine.Table))throw new shine.Error("Bad argument #1 to 'maxn' (table expected)");return a.__shine.numValues.length-1},remove:function(a,b){if(!((a||shine.EMPTY_OBJ)instanceof shine.Table))throw new shine.Error("Bad argument #1 to 'remove' (table expected)");var c=shine.lib.table.getn(a),d=a.__shine.numValues,e;if(!(b>c)){void 0==b&&(b=c);for(e=d.splice(b,1);b<c&&void 0===d[b];)delete d[b++];return e}},
sort:function(a,b){if(!((a||shine.EMPTY_OBJ)instanceof shine.Table))throw new shine.Error("Bad argument #1 to 'sort' (table expected)");var c,d=a.__shine.numValues;if(b){if(!((b||shine.EMPTY_OBJ)instanceof shine.Function))throw new shine.Error("Bad argument #2 to 'sort' (function expected)");c=function(a,c){return b.apply(null,[a,c],!0)[0]?-1:1}}else c=function(a,b){return a<b?-1:1};d.shift();d.sort(c).unshift(void 0)},unpack:function(a,b,c){if(!((a||shine.EMPTY_OBJ)instanceof shine.Table))throw new shine.Error("Bad argument #1 to 'unpack' (table expected)");
